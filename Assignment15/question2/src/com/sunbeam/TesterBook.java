...
public class TesterBook {
	...
	public static void main(String[] args) {
		...
		while ((choice = menu())!=0) {
			...
			case 7: try (FileOutputStream fileOut = new FileOutputStream("books.ser"); 
			...
			case 8: try (FileInputStream fileIn = new FileInputStream("books.ser"); 
					ObjectInputStream objectIn = new ObjectInputStream(fileIn)) 
			{ 
				list = (List<Book>) objectIn.readObject(); 
				System.out.println("Books have been loaded from 'books.ser'"); 
				} 
